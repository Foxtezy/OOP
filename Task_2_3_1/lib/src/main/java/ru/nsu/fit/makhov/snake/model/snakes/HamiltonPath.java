...
/**
 * Class which construct hamilton path.
 */
@UtilityClass
public class HamiltonPath {
   ...
   *
   * @param boundX wight of field.
   * @param boundY height of field.
  ...
  private static boolean hamiltonStep(List<Point2D> hamiltonPath, List<Direction> commandPath,
      int boundX, int boundY, Point2D current) {
    ...
    List<Direction> directions = List.of(Direction.DOWN, Direction.LEFT, Direction.UP,
        Direction.RIGHT);
